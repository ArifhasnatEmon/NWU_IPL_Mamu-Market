...
const FAQS = [
  ...
  { id: 'payment', category: 'Payments & MFS', icon: 'fa-mobile-alt', color: 'emerald', items: [
    ...
    { q: 'My bKash payment failed but money was deducted. What do I do?', a: 'Contact us within 24 hours at support.mamumarket@gmail.com with your transaction ID. We will reconcile it within 2–3 business days.' },
  ]},
  ...
  { id: 'vendor', category: 'Vendor Support', icon: 'fa-store', color: 'indigo', items: [
    { q: 'How do I become a vendor?', a: 'Click "Become a Vendor" on the homepage, fill out the registration form and submit. Your account will be activated once admin approves.' },
    { q: 'How do I upload a product?', a: 'Go to Dashboard → Add Product, fill in the details, images and price. The product goes live after admin approval.' },
    { q: 'When do I receive my payout?', a: 'Payouts are processed weekly for completed orders past the 7-day return window, sent to your bKash, Nagad, or bank account.' },
    { q: 'How do I manage my orders?', a: 'Go to Dashboard → My Orders to see all incoming orders, update shipping status, and manage deliveries.' },
  ]},
  { id: 'orders', category: 'Order Issues', icon: 'fa-box', color: 'purple', items: [
    ...
    { q: 'I received the wrong product. What should I do?', a: 'Contact us within 48 hours at support.mamumarket@gmail.com with a photo of the product. We will resolve it promptly.' },
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="min-h-screen pb-20 bg-[#F5F5F8]">
      ...
      <div className="max-w-[860px] mx-auto px-4 -mt-10 relative z-20">
        <div className="bg-white rounded-[24px] p-8 md:p-14 shadow-[0_2px_32px_rgba(0,0,0,0.10)]">
          ...
          {/* Contact box */}
          <div className="bg-brand-50 border border-brand-100 rounded-2xl p-8 mt-10 flex items-start gap-6">
            <div className="w-12 h-12 bg-brand-600 text-white rounded-xl flex items-center justify-center shrink-0">
              <i className="fas fa-headset text-xl"></i>
            </div>
            <div>
              <h3 className="font-black text-gray-900 mb-1">Still need help?</h3>
              <p className="text-sm text-gray-600 font-medium mb-3">Our support team is available every day from 9 AM to 10 PM.</p>
              <p className="text-sm font-black text-brand-600">support.mamumarket@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
